...
public class DatabasesManager {
  ...
  public void createDatabases() {
    ...
    createDatabase(accountsDataSource,
        "create table accounts(id INT NOT NULL, clientId INT NOT NULL, referenceNumber VARCHAR(45) NOT NULL, PRIMARY KEY (id) )");
    createDatabase(secretsDataSource,
        "create table passwords(id INT NOT NULL, userId INT NOT NULL, password VARCHAR(45) NOT NULL, PRIMARY KEY (id) )");
  }
  ...
  private DataSource getDataSourceByName(String name) {
    return switch (name) {
      ...
      case "users" -> usersDataSource;
      case "accounts" -> accountsDataSource;
      case "secrets" -> secretsDataSource;
      default -> null;
    };
  }
