...
public class ConnectionFactoryImpl implements ConnectionFactory, ConnectionFactoryManagedBean {

  private static final FormatLogger log = new FormatLogger(ConnectionFactoryImpl.class);
  ...
  public void init() {
    ...
    if (registerAsMBean) {
      MBeanUtil.registerMBeanQuietly(this, "com.transferwise.common.gaffer:type=JmsConnectionFactory,name=" + uniqueName);
    }
  }
